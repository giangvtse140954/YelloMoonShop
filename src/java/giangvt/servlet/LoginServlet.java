...
import giangvt.tbluser.TblUserDTO;
...
public class LoginServlet extends HttpServlet {
    ...
    private final String LOGIN_ERROR = "login_error.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TblUserDTO result = dao.checkLogin(userId, password);
            if (result != null) {
            ...
            LOGGER.info("LoginServlet _ SQL: " + ex.getMessage());
        } catch (NamingException ex) {
            LOGGER.info("LoginServlet _ Naming: " + ex.getMessage());
        } finally {
